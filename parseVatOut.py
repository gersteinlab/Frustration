...
Usage:
  parseVatOut.py -b <bioMartFile> -v <vatOut> -d <dataResource> -type <snpType>  
...
def extractGeneID(inputVatFile,bioMartInfo,dataSource,snpType):
    ...
    fileOut = open(dataSource+'.'+snpType+".summary","a")
...
def main(arguments):
    ...
    ensembleOutList = extractFASTAInfo(biomartFile)
        
    extractGeneID(vatOutputFile,ensembleOutList,dataResource,codingSNPType)
